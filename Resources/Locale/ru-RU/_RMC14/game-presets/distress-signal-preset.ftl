...
cm-distress-signal-selfdestruct = [color=yellow]Детонация антиматериального реактора.[/color]
...
rmc-distress-signal-preflight-complete = Десантные кораьля заправлены и готовы к вылету.
...
rmc-distress-signal-scuttle-final = Последнее предупреждение. Неизбежен выход из строя защитной оболочки активной зоны ядра. Последовательность аварийного затепления неизбежна.
rmc-distress-signal-scuttle-deck-creak = Палуба корабля тревожно скрипит под вами.
rmc-distress-signal-scuttle-runaway-meltdown = ТРЕВОГА: Антиматериальные реакторы перегружены. Расплавление активной зоны ядра неизбежно.
rmc-distress-signal-scuttle-heat-aura = Воздух вокруг ядра обжигает вашу кожу.
rmc-distress-signal-scuttle-superheat-aura = Тепло в сердечнике ядра становится обжигающим!

rmc-xeno-announcement-scuttle-first-overload = Гуманоиды перегружают пылающие сердца стального улья. Остановите их, пока летающий улей не истерзает себя полностью.
